    ...
    application {
        ...
        nativeDistributions {
            ...
            macOS {
                ...
                dockName = "Hermes"
                infoPlist {
                    extraKeysRawXml = "<key>HermesBuildRevision</key><string>reasoning-capabilities-1.8.9</string><key>NSMicrophoneUsageDescription</key><string>Hermes 使用麦克风进行语音输入和对话。</string><key>NSSpeechRecognitionUsageDescription</key><string>Hermes 将录音识别为对话文字。</string>"
                }
            }
        }
    }
